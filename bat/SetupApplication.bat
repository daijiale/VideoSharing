...
:: Android packaging
set AND_CERT_NAME="P2PClient"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\P2PClient.p12
...
set IOS_PROVISION=cert\P2PClient.mobileprovision
...
set APP_ID=air.P2PClient

:: Output packages
set DIST_PATH=dist
set DIST_NAME=P2PClient
